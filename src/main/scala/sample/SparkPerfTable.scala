...
object SparkPerfTable {
  def main(args: Array[String]): Unit = {

    val conf = new SparkConf().setAppName("SparkPerfTable")
    ...
    val tables = new SampleTPCDSTables(sqlContext,
  ...
  class SampleTPCDSTables(
                           sqlContext: SQLContext,
                           useDoubleForDecimal: Boolean = false,
                           useStringForDate: Boolean = false) extends SampleTables(sqlContext, useDoubleForDecimal, useStringForDate) {
